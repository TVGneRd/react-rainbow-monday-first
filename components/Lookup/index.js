...
var _isScrollPositionAtMenuBottom = _interopRequireDefault(
    require('./helpers/isScrollPositionAtMenuBottom'),
);
...
var Lookup = (function(_Component) {
    ...
    function Lookup(props) {
        ...
        _this.state = {
            ...
            focusedItemIndex: (0, _helpers.getInitialFocusedIndex)(
                normalizedOptions,
        ...
        _this$keyHandlerMap);
        _this.handleScrollDownArrowHover = _this.handleScrollDownArrowHover.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleScrollUpArrowHover = _this.handleScrollUpArrowHover.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.stopArrowScoll = _this.stopArrowScoll.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.updateScrollingArrows = _this.updateScrollingArrows.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleWindowScroll = _this.handleWindowScroll.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleOverlayOpened = _this.handleOverlayOpened.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
    ...
    (0, _createClass2['default'])(Lookup, [
        ...
        },
        {
            ...
            value: function scrollUp(prevFocusedIndex) {
                ...
                if (
                    ...
                    !(0, _helpers.isOptionVisible)(prevFocusedOption, menu)
                ) {
        ...
        },
        {
            ...
            value: function scrollDown(nextFocusedIndex) {
                ...
                if (
                    options.length > visibleOptionsAmount &&
                    !(0, _helpers.isOptionVisible)(nextFocusedOption, menu)
                ) {
        ...
        },
        {
            ...
            value: function handleWindowScroll(event) {
                if (this.menuRef.current && this.menuRef.current.getRef().contains(event.target))
                    return;
                this.closeMenu();
            },
        },
