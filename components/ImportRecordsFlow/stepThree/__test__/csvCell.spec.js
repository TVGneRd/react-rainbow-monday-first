...
describe('<CSVCell />', function () {
  it('should return the same value if value is sent as param', function () {
    var returnValue = (0, _enzyme.mount)(_react["default"].createElement(_csvCell["default"], {
      value: "test-value"
    }));
    expect(returnValue.text()).toBe('test-value');
  });
  it('should have assign field content when no value is sent as param', function () {
    var component = (0, _enzyme.mount)(_react["default"].createElement(_csvCell["default"], null));
  ...
  it('should trigger click event using database param', function () {
    ...
    var component = (0, _enzyme.mount)(_react["default"].createElement(_csvCell["default"], {
      onClick: onClickFn,
      row: row
    }));
