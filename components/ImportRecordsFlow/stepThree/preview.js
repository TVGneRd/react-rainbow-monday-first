...
var _getFieldAssignedPreviewData = _interopRequireDefault(
    require('../helpers/getFieldAssignedPreviewData'),
);
...
function Preview(props) {
    ...
    var mappedData = (0, _getFieldAssignedPreviewData['default'])(
        data,
        field,
        fileFields,
        attributes,
    ...
    if (fileFields.length) {
        ...
        return _react['default'].createElement(
            ...
            _react['default'].createElement(
                _previewText['default'],
                null,
                'Assigning',
                _react['default'].createElement(
                    'b',
                    null,
                    ' \u201C'.concat(fieldsToAssing, '\u201D'),
                ),
                ' ',
                ''.concat(fieldWord, ' to'),
                _react['default'].createElement('b', null, ' \u201C'.concat(field, '\u201D')),
                ' database field',
            ),
            _react['default'].createElement(
                _table['default'],
