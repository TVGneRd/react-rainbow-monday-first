...
function AssignFieldModal(props) {
    ...
    var selectFileField = function selectFileField(event) {
        ...
        setFileFieldsOptions(
            fileFieldsOptions.filter(function(field) {
                return field.value !== value;
            }),
        );
        setFileFieldsToAssign(
            [].concat((0, _toConsumableArray2['default'])(fileFieldsToAssign), [value]),
        );
    };

    var deleteFileField = function deleteFileField(value) {
        setFileFieldsOptions(
            [].concat((0, _toConsumableArray2['default'])(fileFieldsOptions), [
                {
                    label: value,
                    value: value,
                },
        ...
        setFileFieldsToAssign(
            fileFieldsToAssign.filter(function(field) {
                return field !== value;
            }),
        );
    };
