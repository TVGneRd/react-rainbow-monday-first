...
function CSVCell(props) {
  ...
  return _react["default"].createElement(_cvsFieldContainer.CellContainer, null, _react["default"].createElement(_RenderIf["default"], {
    isTrue: value
  }, value, _react["default"].createElement(_ButtonIcon["default"], {
    ...
    isTrue: !value
  }, _react["default"].createElement(_cvsFieldContainer.StyledCVSFieldContainer, null, _react["default"].createElement(_cancelIcon["default"], null), "Not assigned yet"), _react["default"].createElement(_ButtonIcon["default"], {
    variant: "outline-brand",
    onClick: function onClick() {
      return _onClick(row.databaseField);
    },
