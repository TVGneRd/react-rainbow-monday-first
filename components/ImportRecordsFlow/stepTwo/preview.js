...
function Preview(props) {
    ...
    return _react['default'].createElement(
        ...
        _react['default'].createElement(
            ...
            _react['default'].createElement(_csv['default'], null),
            _react['default'].createElement(
                _fileCardContent['default'],
                null,
                _react['default'].createElement(
                    _fileCardTitle['default'],
                    {
                        title: name,
                    },
                    name,
                ),
                _react['default'].createElement(_fileCardDescription['default'], null, type),
            ),
