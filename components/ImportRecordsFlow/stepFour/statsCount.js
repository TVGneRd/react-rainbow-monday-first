...
function StatsCount(props) {
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_RenderIf["default"], {
    isTrue: type === 'success'
  }, _react["default"].createElement(_checkCircle["default"], null)), _react["default"].createElement(_RenderIf["default"], {
    isTrue: type === 'error'
  }, _react["default"].createElement(_xCircle["default"], null)), _react["default"].createElement(_statsCardDescription["default"], null, description));
}
