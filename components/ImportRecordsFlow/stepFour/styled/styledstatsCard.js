...
var StyledStatsCard = (0, _attachThemeAttrs["default"])(_styledComponents["default"].div)(_templateObject || (_templateObject = (0, _taggedTemplateLiteral2["default"])(["\n    border: solid 1px ", ";\n    background-color: ", ";\n    padding: 10px 8px 10px 16px;\n    display: flex;\n    align-items: center;\n    margin: 0 16px 16px 16px;\n    border-radius: 12px;\n\n    ", ";\n        \n    ", ";\n        \n    ", ";\n"])), function (props) {
