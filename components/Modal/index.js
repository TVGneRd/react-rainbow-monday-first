...
var Modal = (function(_Component) {
    ...
    function Modal(props) {
        ...
        _this.handleKeyPressed = _this.handleKeyPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleClick = _this.handleClick.bind((0, _assertThisInitialized2['default'])(_this));
        _this.closeModal = _this.closeModal.bind((0, _assertThisInitialized2['default'])(_this));
        _this.addBackdropClickListener = _this.addBackdropClickListener.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.removeBackdropClickListener = _this.removeBackdropClickListener.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        return _this;
    }
