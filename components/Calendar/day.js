...
function DayComponent(props) {
    ...
    var isDisabled =
        isAdjacentDate ||
        (0, _helpers.compareDates)(date, maxDate) > 0 ||
        (0, _helpers.compareDates)(date, minDate) < 0 ||
        (maxRangeEnd && (0, _helpers.compareDates)(date, maxRangeEnd) > 0) ||
        (0, _isInArray['default'])(date, disabledDays);
...
function Day(props) {
    return _react['default'].createElement(_context.Consumer, null, function(values) {
        return _react['default'].createElement(
            DayComponent,
            (0, _extends2['default'])({}, values, props),
        );
    });
}
