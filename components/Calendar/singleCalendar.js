...
var SingleCalendar = (function(_Component) {
    ...
    function SingleCalendar(props) {
        ...
        _this.previousMonth = _this.previousMonth.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.nextMonth = _this.nextMonth.bind((0, _assertThisInitialized2['default'])(_this));
        _this.handleYearChange = _this.handleYearChange.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyDown = _this.handleKeyDown.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyUpPressed = _this.handleKeyUpPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyDownPressed = _this.handleKeyDownPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyLeftPressed = _this.handleKeyLeftPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyRightPressed = _this.handleKeyRightPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyHomePressed = _this.handleKeyHomePressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyEndPressed = _this.handleKeyEndPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyPageUpPressed = _this.handleKeyPageUpPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyPageDownPressed = _this.handleKeyPageDownPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyEnterPressed = _this.handleKeyEnterPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyAltPageUpPressed = _this.handleKeyAltPageUpPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        _this.handleKeyAltPageDownPressed = _this.handleKeyAltPageDownPressed.bind(
            (0, _assertThisInitialized2['default'])(_this),
        );
        ...
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.UP_KEY,
            _this.handleKeyUpPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.DOWN_KEY,
            _this.handleKeyDownPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.LEFT_KEY,
            _this.handleKeyLeftPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.RIGHT_KEY,
            _this.handleKeyRightPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.HOME_KEY,
            _this.handleKeyHomePressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.END_KEY,
            _this.handleKeyEndPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.PAGEUP_KEY,
            _this.handleKeyPageUpPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.PAGEDN_KEY,
            _this.handleKeyPageDownPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
            _constants.SPACE_KEY,
            _this.handleKeyEnterPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMap,
        ...
        (0, _defineProperty2['default'])(
            _this$keyHandlerMapAl,
            _constants.PAGEUP_KEY,
            _this.handleKeyAltPageUpPressed,
        ),
        (0, _defineProperty2['default'])(
            _this$keyHandlerMapAl,
            _constants.PAGEDN_KEY,
            _this.handleKeyAltPageDownPressed,
        ),
        _this$keyHandlerMapAl);
    ...
    (0, _createClass2['default'])(SingleCalendar, [
        {
            ...
            value: function componentDidUpdate(prevProps) {
                ...
                if (
                    (0, _helpers.formatDate)((0, _helpers.normalizeDate)(prevValue)) !==
                    (0, _helpers.formatDate)(normalizedDate)
                ) {
        ...
        },
        {
            ...
            value: function moveFocusedDay(increment) {
                ...
                if (!(0, _helpers.isSameMonth)(nextFocusedDate, currentMonth)) {
                    nextFocusedMonth = (0, _helpers.getFirstDayMonth)(
                        (0, _helpers.addMonths)(currentMonth, (0, _helpers.getSign)(increment)),
                    );
                }
                    ...
                    value.length === 1
                        ? Math.min.apply(
                              ...
                              (0, _toConsumableArray2['default'])(
                                  disabledDays.filter(function(day) {
        ...
        },
        {
            ...
            value: function handleKeyEnterPressed() {
                ...
                var focusedDate = this.state.focusedDate;
                if (
                    disabledDays.some(function(day) {
        ...
        },
        {
            ...
            value: function render() {
                ...
                var prevDate = (0, _helpers.getLastDayMonth)(
                    (0, _helpers.addMonths)(currentMonth, -1),
                );
...
SingleCalendar.propTypes = {
    ...
    selectedRange: _propTypes['default'].arrayOf(
        _propTypes['default'].oneOfType([
            _propTypes['default'].instanceOf(Date),
            _propTypes['default'].string,
        ]),
    ),
    disabledDays: _propTypes['default'].arrayOf(
        _propTypes['default'].oneOfType([
            _propTypes['default'].string,
            _propTypes['default'].instanceOf(Date),
        ]),
