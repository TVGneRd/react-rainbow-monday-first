...
var _shouldUpdateCurrentMonth = _interopRequireDefault(
    require('./helpers/shouldUpdateCurrentMonth'),
);
...
function DoubleCalendar(props) {
    ...
    var _useDisabledControls = (0, _hooks2.useDisabledControls)(
            yearsRange,
            minDate,
            maxDate,
            currentMonth,
    ...
    var handleKeyDown = (0, _hooks2.useHandleKeyDown)(
        focusedDate,
        currentMonth,
        rightCalendarMonth,
        minDate,
    ...
    var handleOnDayHover = (0, _react.useCallback)(
        function(date) {
    ...
    var prevMonthClick = (0, _react.useCallback)(
        function() {
    ...
    var nextMonthClick = (0, _react.useCallback)(
        function() {
            var newMonth = (0, _helpers.addMonths)(currentMonth, 1);
            setFocusedDate((0, _helpers.getNextFocusedDate)(value, newMonth));
            setCurrentMonth(newMonth);
    ...
    var handleLeftCalendarYearChange = (0, _react.useCallback)(
        function(event) {
    ...
    var handleRightCalendarYearChange = (0, _react.useCallback)(
        function(event) {
            var year = +event.target.value;
    ...
    (0, _react.useEffect)(
        function() {
            ...
            if (
                (0, _shouldUpdateCurrentMonth['default'])(
                    currentValue,
                    currentMonth,
                    rightCalendarMonth,
                )
                ...
                selectedRange && selectedRange.length === 1
                    ? Math.min.apply(
                          ...
                          (0, _toConsumableArray2['default'])(
                              normalizedDisabledDays.filter(function(day) {
    ...
    return _react['default'].createElement(
        ...
        _react['default'].createElement(
            _styled.StyledControlsContainer,
            null,
            ...
            _react['default'].createElement(
                ...
                _react['default'].createElement(_yearSelect['default'], {
