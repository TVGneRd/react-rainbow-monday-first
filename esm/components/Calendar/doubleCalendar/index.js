...
export default function DoubleCalendar(props) {
    ...
    var _useDisabledControls = useDisabledControls(
            yearsRange,
            minDate,
            maxDate,
            currentMonth,
    ...
    var handleKeyDown = useHandleKeyDown(
        focusedDate,
        currentMonth,
        rightCalendarMonth,
        minDate,
    ...
    var handleOnDayHover = useCallback(
        function(date) {
    ...
    var prevMonthClick = useCallback(
        function() {
    ...
    var nextMonthClick = useCallback(
        function() {
            var newMonth = addMonths(currentMonth, 1);
            setFocusedDate(getNextFocusedDate(value, newMonth));
            setCurrentMonth(newMonth);
    ...
    var handleLeftCalendarYearChange = useCallback(
        function(event) {
    ...
    var handleRightCalendarYearChange = useCallback(
        function(event) {
            var year = +event.target.value;
