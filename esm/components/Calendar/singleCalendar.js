...
var SingleCalendar = (function(_Component) {
    ...
    function SingleCalendar(props) {
        ...
        _defineProperty(_this$keyHandlerMap, UP_KEY, _this.handleKeyUpPressed),
        _defineProperty(_this$keyHandlerMap, DOWN_KEY, _this.handleKeyDownPressed),
        _defineProperty(_this$keyHandlerMap, LEFT_KEY, _this.handleKeyLeftPressed),
        _defineProperty(_this$keyHandlerMap, RIGHT_KEY, _this.handleKeyRightPressed),
        _defineProperty(_this$keyHandlerMap, HOME_KEY, _this.handleKeyHomePressed),
        _defineProperty(_this$keyHandlerMap, END_KEY, _this.handleKeyEndPressed),
        _defineProperty(_this$keyHandlerMap, PAGEUP_KEY, _this.handleKeyPageUpPressed),
        _defineProperty(_this$keyHandlerMap, PAGEDN_KEY, _this.handleKeyPageDownPressed),
        _defineProperty(_this$keyHandlerMap, SPACE_KEY, _this.handleKeyEnterPressed),
        _defineProperty(_this$keyHandlerMap, ENTER_KEY, _this.handleKeyEnterPressed),
        _this$keyHandlerMap);
        _this.keyHandlerMapAlt = ((_this$keyHandlerMapAl = {}),
        _defineProperty(_this$keyHandlerMapAl, HOME_KEY, _this.handleKeyHomePressed),
        _defineProperty(_this$keyHandlerMapAl, END_KEY, _this.handleKeyEndPressed),
        _defineProperty(_this$keyHandlerMapAl, PAGEUP_KEY, _this.handleKeyAltPageUpPressed),
        _defineProperty(_this$keyHandlerMapAl, PAGEDN_KEY, _this.handleKeyAltPageDownPressed),
        ...
        },
        {
            ...
            value: function moveFocusedDay(increment) {
                ...
                if (!isSameMonth(nextFocusedDate, currentMonth)) {
                    nextFocusedMonth = getFirstDayMonth(
                        addMonths(currentMonth, getSign(increment)),
                    );
                }
