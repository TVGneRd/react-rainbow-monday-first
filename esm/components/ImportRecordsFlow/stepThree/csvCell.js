...
export default function CSVCell(props) {
  ...
  return React.createElement(CellContainer, null, React.createElement(RenderIf, {
    isTrue: value
  }, value, React.createElement(ButtonIcon, {
    ...
    isTrue: !value
  }, React.createElement(StyledCVSFieldContainer, null, React.createElement(StyledCancelIcon, null), "Not assigned yet"), React.createElement(ButtonIcon, {
    variant: "outline-brand",
    onClick: function onClick() {
      return _onClick(row.databaseField);
    },
